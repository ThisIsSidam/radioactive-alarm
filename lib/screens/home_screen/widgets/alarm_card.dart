            ...
            ExpansionTile(
              ...
              children:  [
                ...
                ListTile(
                  ...
                  onTap: () {
                    ref.read(alarmsProvider).deleteAlarm(widget.alarm.id);
                  },
                ),
              ],
            ),
          ...
          isExpanded
              ? Flexible(
                  child: ListTile(
                    ...
                    minTileHeight: 18,
                    leading:
                        isExpanded ? const Icon(Icons.label_outline) : null,
                    title: isExpanded
                        ? const Text('label')
        ...
        children: [
          TextSpan(
            ...
            style: TextStyle(
              fontSize: 40,
              fontWeight:
                  widget.alarm.isEnabled ? FontWeight.bold : FontWeight.w300,
            ),
          ),
          TextSpan(
            text: ' ${isAm ? 'am' : 'pm'}',
            style: TextStyle(
              fontSize: 12,
              fontWeight:
                  widget.alarm.isEnabled ? FontWeight.bold : FontWeight.w400,
            ),
          ),
        ],
      ),
